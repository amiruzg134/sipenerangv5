  ...
  <div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
            ...
            <div class="col-lg-6 m-auto">
              <div class="row">
                <div class="col-sm-4 col-6 ps-sm-0 ms-auto">
                  <a href="https://sukma.jatimprov.go.id/fe/survey?idUser=190&idEvent=6645" target="_blank" class="btn bg-gradient-warning mb-0 ms-lg-3 ms-sm-2 mb-sm-0 mb-2 me-auto w-100 d-block">Survey Kepuasan Masyarakat</a>
                </div>
    ...
    <div class="container py-5">
      <div class="py-5 bg-gradient-dark position-relative border-radius-xl" style="background-image:url('https://images.unsplash.com/photo-1533563906091-fdfdffc3e3c4?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1950&amp;q=80')" loading="lazy">
        <div class="container position-relative z-index-2">
          <div class="row">
            <div class="col-lg-5 m-auto text-start">
              <h5 class="text-white mb-lg-0 mb-5"> ONE HIKER ONE TREE (ONHOT)</h5>
              <p class="text-white mb-lg-0 mb-5"> Adalah program pemulihan ekosistem kawasan Tahura Raden Soerjo dengan menggalang partisipasi masyarakat untuk berkontribusi dalam kegiatan penanaman melalui donasi yang disalurkan kepada TRC Relawan Tahura. Donasi ini selanjutnya akan dipergunakan untuk membiayai penyediaan bibit, penanaman, pemeliharaan dan perlindungan yang dilakukan oleh TRC relawan Tahura.</p>
            </div>
            <div class="col-lg-6 m-auto">
              <div class="row">
                <div class="col-sm-4 col-6 ps-sm-0 ms-auto">
                  <a href="http://onehikeronetree.com" target="_blank" class="btn btn-white mb-0 ms-lg-3 ms-sm-2 mb-sm-0 mb-2 me-auto w-100 d-block">Donate!</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="accordion p-3" id="accordionRental">
                ...
                <div class="accordion-item mb-3">
                  <h5 class="accordion-header" id="headingSixth">
                    <button class="accordion-button border-bottom font-weight-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSixth" aria-expanded="false" aria-controls="collapseSixth">
                      Jam Pelayanan Pos Perizinan dan Batas Waktu Trekking
                      <i class="collapse-close fa fa-plus text-xs pt-1 position-absolute end-0"></i>
                      <i class="collapse-open fa fa-minus text-xs pt-1 position-absolute end-0"></i>
                    </button>
                  </h5>
                  <div id="collapseSixth" class="accordion-collapse collapse" aria-labelledby="headingSixth" data-bs-parent="#accordionRental">
                    <div class="accordion-body text-sm opacity-8">
                      <ul>
                          <li>Gunung Arjuno : Hari senin - minggu pukul 08.00 - 17.00</li>
                          <li>Bukit Lincing : Hari senin - minggu pukul 06.00 - 21.00</li>
                          <li>Gunung Pundak : Hari senin - minggu pukul 08.00 - 17.00 (weekend s.d. pukul 23.00)</li>
                          <li>Khusus trekking pendakian Bukit Lincing pada malam/dini/pagi hari harus melakukan booking 2 hari dan regist ulang di pos perizinan pada hari pertama sesuai jam pelayanan.</li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div class="accordion-item mb-3">
                  ...
                  <div id="collapsetujuh" class="accordion-collapse collapse" aria-labelledby="tujuh" data-bs-parent="#accordionRental">
                    <div class="accordion-body text-sm opacity-8">
                      Pembayaran hanya non tunai melalui transfer ke Nomor Rekening Virtual Account yang diterima setelah melakukan booking.
                    </div>
                  </div>
                </div>
                <div class="accordion-item mb-3">
                ...
                <div class="accordion-item mb-3">
                  ...
                  <div id="collapsesepuluh" class="accordion-collapse collapse" aria-labelledby="sepuluh" data-bs-parent="#accordionRental">
                    <div class="accordion-body text-sm opacity-8">
                      <b>Masa berlaku surat keterangan sehat maksimal H-2 sebelum tanggal naik</b>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="d-flex ps-0">
                          <i class="material-icons text-sm">call</i>
                          <span class="ps-3">Admin 1 (booking & perubahan anggota) - 085156579564 (<span style="color:red">teks</span>) </span>
                        </div>
                        <div class="d-flex ps-0">
                          <i class="material-icons text-sm">call</i>
                          <span class="ps-3">Admin 2 (porter, guide, trail run & perizinan kegiatan) - 081554432204 </span>
                        </div>
                      </div>
                      <div class="col-md-6">
      ...
      <div class="modal-content bg-gradient-danger">
        <div class="modal-body">
          <div class="py-3 text-center text-white">
            ...
            <img src="assets/img/penutupan.jpg" style="width: 100%; display: block; margin: 0 auto;">
            <!--<h4 class="heading mt-4 text-white">Booking tidak dapat dilakukan pada pukul 23.00 - 04.00</h4>-->
          </div>
        </div>

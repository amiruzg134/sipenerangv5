                    ...
                    <div class="col-lg-4 my-auto">
                        ...
                        if (!isset($_SESSION['uuid'])) {
                            ...
                            <form method="post" action="booking.php">
                                <input type="hidden" name="tjn" value="<?php echo $_POST['tjn']?>">
                                <input type="hidden" name="wni" value="<?php echo $_POST['wni']?>">
                                <input type="hidden" name="wna" value="<?php echo $_POST['wna']?>">
                                <input type="hidden" name="tglnaik" value="<?php echo $_POST['tglnaik']?>">
                                <input type="hidden" name="tglturun" value="<?php echo $_POST['tglturun']?>">
                                <input type="hidden" name="totalbayar" value="<?php echo $totalbayar?>">
                                <button class="btn bg-gradient-danger btn-lg mt-2">ISI FORM</button>
                            </form>
                            <?php
                        }{
                            ?>
                            <form method="post" action="login.php">
                                ...
                                <input type="hidden" name="tglturun" value="<?php echo $_POST['tglturun']?>">
                                <input type="hidden" name="totalbayar" value="<?php echo $totalbayar?>">
                                <button class="btn bg-gradient-danger btn-lg mt-2">Login</button>
                            </form>
                            </br>
                            ...
                            <form method="post" action="register.php">
                                ...
                                <input type="hidden" name="tglturun" value="<?php echo $_POST['tglturun']?>">
                                <input type="hidden" name="totalbayar" value="<?php echo $totalbayar?>">
                                <button class="btn bg-gradient-danger btn-lg mt-2">Register</button>
                            </form>
                            <?php
                        }
                        ?>

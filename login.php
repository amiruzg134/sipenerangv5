        ...
        <div class="col-md-12 col-xl-5">
            <div class="h-100 d-flex flex-column align-items-center justify-content-center">
                <div class="p-4 w-100 w-md-50 w-xl-75">
                    <h4 class="mb-4">Masuk Sekarang Juga</h4>
                    <form action="" method="post">
                        <div class="">
                            ...
                            <button type="button" id="btn_submit" class="btn btn-primary w-100">
                                <span id="btn-text-proses">Login</span>
                        ...
                        <div class="container" style="margin-top: 10px;">
                            <center>
                                ...
                                <a href="<?php echo $login_button;?>" class="login-with-google-btn" >
                                    Sign in with Google
                                </a>
                            </center>
                        </div>

...
$mpdf = new \Mpdf\Mpdf();
  ...
  $sql5 = mysqli_query($conn, "SELECT * FROM tb_logistik WHERE lg_pendakian = '$_GET[id]'");
    ...
    \PHPQRCode\QRcode::png($codeContents, "qrcode.png");
?>
...
<?php
    $url_base = "http://localhost/sipenerangv4-master/assets/img/LogoJawaTimur.png"
?>
<table class="tg" style="undefined;table-layout: fixed; width: 720px">
    <tr>
        <td class="centered" style="text-align: right; overflow: auto">
  ...
  ?>
    ...
    <tr>
        <td style="padding: 5px 3px" class="tg-vlyc" colspan="4">Memasuki Kawasan Tahura Raden Soerjo untuk melakukan pendakian <strong> GUNUNG PUNDAK</strong> mulai tanggal <?php echo date('d/m/Y', strtotime($row['tgl_naik'])).' s/d '.date('d/m/Y', strtotime($row['tgl_turun'])).' selama '. $hari; ?> hari, dengan ketentuan sebagai berikut :</td>
    </tr>
...
<div class="page_break">
    ...
    <table class="ta">
        ...
        while ($anggota = mysqli_fetch_array($sql2)) { ?>
          <tr>
              ...
              <td class="tg-0lax" ><?php echo $anggota['ap_nama']; ?></td>
    ...
    <table class="ta">
      <tr>
        <th class="tg-hgcj" style="width: 200px">Nama</th>
        <th class="tg-hgcj" style="width: 100px">No. Telepon</th>
        <th class="tg-hgcj" style="width: 200px">Alamat</th>
    ...
    <h5 style="margin-bottom: 5px">III. DAFTAR PERLENGKAPAN PENDAKI (isi form saat di Pos Pendakian)</h5>
    <table class="ta">
        <tr>
    ...
    <h5 style="margin-bottom: 5px">IV. DAFTAR LOGISTIK PENDAKI (isi form saat di Pos Pendakian)</h5>
    <table class="ta">
        <tr>
            <th class="tg-hgcj" style="width: 10px">No</th>
            <th class="tg-hgcj" style="width: 450px">Logistik</th>
            <th class="tg-hgcj" style="width: 150px">Jumlah</th>
        </tr>
        ...
        <?php
            ...
            while ($logistik = mysqli_fetch_array($sql5)) { ?>
                <tr>
                    ...
                    <td class="tg-0lax"><?php echo $logistik['lg_jumlah'] ?></td>
                </tr>
            <?php } 
        ?>

...
<section class="content-header" style="margin-bottom: 10px">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Transaksi Terlewatkan</li>
    </ol>
</section>
...
<div class="box">
    ...
    <div class="box-body">
        <table id="table_transaksi_terlewatkan" class="table table-bordered table-hover">
            <thead>
            <tr>
...
<script>
    var table = $('#table_transaksi_terlewatkan').DataTable({
        'retrieve': true,
        'processing': true,
        'serverSide': true,
        'serverMethod': 'post',
        "ajax": {
            'url': 'pages/report/action-transaksi/action.php?action=list_terlewatkan',
            'data': function(data){
    ...
    $('#table_transaksi_terlewatkan tbody').on('click', '.button_menu', function () {

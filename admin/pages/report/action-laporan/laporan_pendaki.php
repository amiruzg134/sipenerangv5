...
?>
    ...
    $pendaki = mysqli_query($conn, "SELECT * FROM tb_pendakian WHERE is_region_new=1 AND tb_gunung_id='$gunung_select' AND pd_pos_pendakian='$pos_select' AND DATE(pd_tgl_naik) BETWEEN '$set_start_date' AND '$set_end_date' ORDER BY pd_tgl_naik");
    ...
    <table>
        ...
        <tr>
            <td colspan="4"><h4  style="text-transform: none;">Laporan Pendaki <?php echo $gunung['nama'].'('.$pos['pp_nama'].')'; ?></h4></td>
        </tr>
        <tr>
                        ...
                        <table class="table table-bordered" style="width: 100%">
                            ...
                            while ($row = mysqli_fetch_array($pendaki)) { ?>
                                <tr style="font-size: 12px">
                                    ...
                                    <td style="text-align: center"><?php echo date('d/m/Y H:i:s', strtotime($row['pd_tgl_naik'])); ?></td>
                                    <?php
                                    if ($row['pd_pos_turun'] == '') { ?>
                                        <td style="text-align: center"><?php echo date('d/m/Y', strtotime($row['pd_tgl_turun']));?><small><strong>(rencana)</strong></small></td>
                                    <?php }
                                    else{ ?>

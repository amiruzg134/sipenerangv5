...
<div class="box">
    <div class="box-body">
        <form method="POST" class="form-horizontal">
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label">Sync Mountain Id </br><small>(ID gunung tiketpendakian)</small></label>
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="mountain_id" id="mountain_id" readonly>
                </div>
            </div>
...
<script>
    ...
    $.ajax({
        type    : "POST",
        url     : "pages/master/action-gunung/action.php?action=detail",
        data    : {
            code_id: code_id
        },
    ...
    $('#update').click(function () {
        ...
        $.ajax({
            type    : "POST",
            url     : "pages/master/action-gunung/action.php?action=update",
            data    : {
                id: id,

...
<script>
    $.ajax({
        type    : "POST",
        url     : "pages/master/action-pengguna/action.php?action=jabatan",
        data    : null,
        success: function (response) {
            ...
            if (json.error){
                ...
                $.each(json.data, function (key_det, value_det) {
    ...
    $('#simpan').click(function () {
        ...
        $.ajax({
            type    : "POST",
            url     : "pages/master/action-pengguna/action.php?action=store",
            data    : {
                nama: nama,
                username: username,
                password: password,

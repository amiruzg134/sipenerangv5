    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (json.error){
                ...
                document.getElementById("data_checked_verifikator").value = json.data.role.rm_acc;
                if(json.data.role.rm_acc === "Y"){
                ...
                document.getElementById("data_checked_broadcast").value = json.data.role.rm_broad;
                if(json.data.role.rm_broad === "Y"){

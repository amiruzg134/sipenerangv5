            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="code" id="code"
                           ...
                           title="Masukkan 2 digit angka">
                    <small class="text-muted">(digunakan untuk membuat kode VA — harus 2 digit angka)</small>
                </div>
            </div>
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (json.error){
                ...
                document.getElementById("code").value = json.data.detail.code;

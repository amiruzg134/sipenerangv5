          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              if ($row['rm_pendaki'] == 'Y') { ?>
                  ...
                  <li id="li_transaksi_terlewatkan">
                      <a class="button_menu" id="transaksi_terlewatkan">
                          <i class="fa fa-calendar"></i> <span>Transaksi Terlewatkan</span>
                      </a>
                  </li>
              <?php } ?>
              <?php
  ...
  <script>
      $(document).ready(function(){
          $('.button_menu').click(function(){
              ...
              }else if(menu === "transaksi_terlewatkan"){
                  $('#data_konten').load('pages/report/transaksi_terlewatkan.php');

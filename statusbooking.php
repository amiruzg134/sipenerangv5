...
<div class="container">
    <div class="col-md-12">
        ...
        ?>
        <section id="respon_trx" style="display: block; margin-top: 10px !important;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if($trxSql['pd_status'] == "menunggu pembayaran"){
                                                    echo "<b style='color: #dedede;'>menunggu pembayaran</b>";
                                                }else if($trxSql['pd_status'] == "menunggu verifikasi"){
                                                    echo "<b style='color: #ffc107;'>menunggu verifikasi</b>";
                                                }else if($trxSql['pd_status'] == "disetujui"){
                                                    echo "<b style='color: #3bd536;'>disetujui</b>";
                                                }else if($trxSql['pd_status'] == "ditolak"){
                                                    echo "<b style='color: #bf4336 ;'>ditolak</b>";
                                                }else if($trxSql['pd_status'] == "sudah naik"){
                                                    echo "<b style='color: #36b6d5 ;'>sudah naik</b>";
                                                }else if($trxSql['pd_status'] == "sudah turun"){
                                                    echo "<b style='color: #36b6d5 ;'>sudah turun</b>";
                                                }
                                                ?>
                                            </td>
                                        </tr>
        ...
        <section style="display: block; margin-top: 50px !important;">
            <div class="row">
                <div class="col-lg-9 col-12 mx-auto">
                    <div class="card">

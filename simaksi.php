...
if (!$id) {
    ...
    \">
        ...
        <p style=\"
            ...
            margin-bottom: 20px;
        \">
            Mohon maaf, untuk transaksi yang dilakukan sebelum tanggal <br><strong>13 Juni 2025</strong> pukul <strong>18:00</strong>, <br>file SIMAKSI tidak tersedia untuk diunduh melalui aplikasi.
        </p>
    </div>
    ";
...
$cekdataPendaki    = mysqli_query($conn, "SELECT pd_id FROM tb_pendakian WHERE pd_id = '$id' AND is_region_new=1");
$rowcekdataPendaki = mysqli_fetch_array($cekdataPendaki);

// Validasi jika data tidak ditemukan
if (!$rowcekdataPendaki) {
    echo "
    <div style=\"
        font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
        background-color: #fff3cd;

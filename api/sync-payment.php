...
try{
    ...
    $expired_at = isset($entityBody['expired_at']) && $entityBody['expired_at'] !== ''
        ...
        $pos_pendakian = mysqli_fetch_array(mysqli_query($conn, "SELECT code FROM tb_pos_pendakian WHERE mountain_gate_id='$mountain_gate_id'"));

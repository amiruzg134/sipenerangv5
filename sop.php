	    ...
	    <div class="row">
	      ...
	      <div class="col-lg-9">
	          ...
	          <div class="card-body p-5">
	            ...
	            <ul>
	              <li>Pendaftaran SIMAKSI secara online hanya melalui website <b class="text-primary"> SiPENERANG </b> atau aplikasi <b class="text-primary"> Tiket Pendakian</b>.</li>
	              <li>Booking dapat dilakukan untuk 30 hari kedepan sampai dengan maksimal H-2 khusus tujuan pendakian Gunung Arjuno dan H-1 khusus pendakian tujuan Bukit Lincing.</li>
	              <li>Batas durasi pendakian yang diizinkan maksimal 3 (tiga) hari 2 (dua) malam.</li>
	              <li>Jam pelayanan pos perizinan pendakian Gunung Arjuno pukul 08.00 - 17.00 WIB dan Bukit Lincing pukul 06.00 - 21.00.</li>
	              <li>Khusus pendakian bukit Lincing yang dilakukan pada malam/dini/pagi hari harus book 2 hari dan regist ulang di pos perizinan pada hari pertama sesuai jam pelayanan.</li>
	              <li><b class="text-primary">Verifikasi Pembayaran</b> dilakukan pada hari Senin s/d Jumat jam 08.00 s/d 15.30 WIB. Proses verifikasi maksimal 1x24 jam hari kerja setelah melakukan pembayaran.</li>
	              <li>Surat Izin Masuk Kawasan Konservasi (eSIMAKSI) khusus pendakian gunung Arjuno diberikan pada kelompok dengan jumlah anggota minimal 3 orang dan menunjuk 1 orang sebagai ketua kelompok yang bertanggung jawab terhadap administrasi pendaki dan keselamatan anggota kelompoknya.</li>
	              ...
	              <li>Tagihan pembayaran dan verifikasi booking akan diterima oleh pemesan melalui email. Pastikan alamat email benar dan sesuai. Apabila tidak ada pesan pemberitahuan pada kotak masuk email, harap periksa pada kotak SPAM.</li>
	              <li>Calon pendaki dapat melakukan pergantian anggota maksimal 1 (satu) kali, dengan batasan waktu 2 (dua) hari (H-2) sebelum keberangkatan. Anggota kelompok yang dapat diganti maksimal 50% dari jumlah anggota.</li>
	              <li>Pendaki yang sudah melakukan booking tidak dapat menambahkan anggota.</li>
	              <li>Pendaki tidak dapat mengubah jalur pendakian ketika sudah melakukan booking.</li>
	              <li>Pendaki melaksanakan pendakian sesuai dengan tanggal naik dan turun sesuai pada SIMAKSI. Petugas berhak menangguhkan jika pendaki naik tidak sesuai dengan tanggal pada SIMAKSI.</li>
	              ...
	              <li><b class="text-dark">BAGI YANG TERBUKTI MELAKUKAN MANIPULASI DAN/ATAU PEMALSUAN DATA, MAKA BOOKING AKAN DIBATALKAN DAN PENDAKI MASUK DALAM <i>BLACKLIST.</i></b></li>
	            </ul>

	            <h3 class="mt-5 mb-3" id="dua">Tarif dan Pembayaran</h3>
	            <p>Setiap pendaki di kawasan Tahura Raden Soerjo dikenakan tarif karcis masuk sesuai dengan ketentuan pada Peraturan Gubernur Jawa Timur Nomor 20 Tahun 2025 Tentang Peninjauan Tarif Retribusi Daerah. Bila terdapat aturan/kebijakan baru tentang tarif karcis masuk di kawasan konservasi, maka tarif karcis pendakian akan disesuaikan sebagaimana peraturan terbaru tersebut.</p>
	            <ol>
	              <li>
                  <p><b>Tarif Pendakian Gunung Arjuno-Welirang dan Bukit Lincing</b></p>
                  <p>Pendaki WNI : Rp. 25.000,- / orang / hari </p>
                ...
                <li>
                	...
                	<p>
                		<ul>
	                  	<li>Meninggal dunia : Rp. 15.000.000</li>
	                  	<li>Cacat tetap : Rp. 15.000.000</li>
	                  	<li>Biaya perawatan : Rp. 1.500.000</li>
                ...
                <li>
	              ...
	              <li>Pembayaran SIMAKSI hanya non tunai dengan transfer ke nomor rekening virtual account yang diterima setelah melakukan booking;</li>
	              <li>Batas waktu pembayaran Virtual Account maksimal 6 (enam) jam setelah melakukan booking. Jika pembayaran melebihi batas waktu yang telah ditentukan maka booking akan hangus;</li>
	              <li>Konfirmasi pembayaran akan diterima oleh ketua rombongan melalui email atau ;</li>
	              ...
	              <li>Pendaki akan dikenakan biaya retribusi SIMAKSI per hari jika konfirmasi turun melebihi tanggal turun pada berkas SIMAKSI.</li>
	            </ol>
	           	...
	           	<ol>
	           		...
	           		<li>
	           			...
	           			<ul>
	           				...
	           				<li>Disarankan membawa alat navigasi/peta;</li>
	           				<li>Disarankan membawa emergency blanket (alumunium foil);</li>
	           				<li>Disarankan membawa hand warmer;</li>
	           			</ul>
	           		</li>

          ...
          <div class="card shadow-lg mb-5">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
              <div class="bg-gradient-primary shadow-primary border-radius-lg p-3">
                <h3 class="text-white mb-0">Panduan Pembayaran</h3>
              </div>
            </div>
            <div class="card-body p-5">
              <h4>Pembayaran Melalui Bank Jatim</h4>
              <ol>
                <li>
              ...
              <h4>Pembayaran Melalui Bank Cimb Niaga</h4>
              <ol>
                <li>
                  Melalui Transfer ATM 
                  <ul>
              ...
              <h4>Pembayaran Melalui Bank Lainnya</h4>
              <ol>
                <li>
                  Melalui Transfer ATM 
                  <ul>
          ...
          <div class="modal-content bg-gradient-danger">
            <div class="modal-body">
              <div class="py-3 text-white">
                  <h6 class="heading mt-4 text-white">Tidak dapat melakukan pembayaran menggunakan : </h6>
                  <ol class="mb-0">
                    <li>Metode transfer BI-FAST, LLG, SKN</li>
                    <li>ATM BRI / BRImo / BRIlink</li>
                    <li>Dana</li>
                    <li>Fastpay</li>
                    <li>Agen Pembayaran</li>
                  </ol>
              </div>
            </div>
